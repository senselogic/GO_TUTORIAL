...
func ( controller * CONTROLLER ) ShowHome( context * golf.Context ) {
    var session SESSION;
    ...
    data := map[ string ] interface {} {
        "Session" : session, "SectionArray" : section_array, "Section" : section, "ArticleArray" : article_array };
...
func ( controller * CONTROLLER ) ShowSection( context * golf.Context ) {
    var session SESSION;
    var section_array [] SECTION;
    var section SECTION;
    var article_array [] ARTICLE;
