...
func ( controller * CONTROLLER ) ShowArticle( context * golf.Context ) {
    var session SESSION;
    ...
    data := map[ string ] interface {} {
        "Session" : session, "SectionArray" : section_array, "Article" : article, "Section" : section, "CommentArray" : comment_array };
