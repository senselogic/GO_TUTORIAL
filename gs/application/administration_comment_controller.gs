...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) EditComments(
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) EditComment(
    context * golf.Context
    )
{
    var session SESSION;
    ...
    id := GetUint32FromString( GetQueryValue( context, "comment_id" ) );
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) ChangeComment(
    context * golf.Context
    )
{
    id := GetUint32FromString( GetQueryValue( context, "comment_id" ) );
    ...
    article_id := GetUint32FromString( GetPostValue( context, "article_id" ) );
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) AddComment(
    context * golf.Context
    )
{
    context.Request.ParseForm();
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) RemoveComment(
    context * golf.Context
    )
{
    comment_id := GetUint32FromString( GetQueryValue( context, "comment_id" ) );
