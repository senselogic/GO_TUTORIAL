...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) EditArticles(
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) EditArticle(
    context * golf.Context
    )
{
    var session SESSION;
    ...
    id := GetIntegerFromString( GetQueryValue( context, "article_id" ) );
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) ChangeArticle(
    context * golf.Context
    )
{
    id := GetIntegerFromString( GetQueryValue( context, "article_id" ) );
    ...
    section_id := GetIntegerFromString( GetPostValue( context, "section_id" ) );
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) AddArticle(
    context * golf.Context
    )
{
    context.Request.ParseForm();
...
func ( administration_controller * ADMINISTRATION_CONTROLLER ) RemoveArticle(
    context * golf.Context
    )
{
