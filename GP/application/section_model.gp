...
func ( model * MODEL ) GetSectionArray(
...
func ( model * MODEL ) GetSectionById(
    section * SECTION,
    id int
    )
{
...
func ( model * MODEL ) ChangeSection(
    id int,
    number int,
    name string,
    text string,
...
func ( model * MODEL ) RemoveSection(
    id int
    )
{
